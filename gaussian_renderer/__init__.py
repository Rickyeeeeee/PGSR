...
def render_without_dual(viewpoint_camera, pc : DualGaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, 
           app_model: AppModel=None, return_plane = False, return_depth_normal = False):
    """
    Render the scene. 
...
def render_with_dual(viewpoint_camera, pc : DualGaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, 
