...
for id, scene in enumerate(scenes):
    ...
    common_args = f"--iterations 7100 -r2 --ncc_scale 0.5 --data_device {data_devices[id]} --densify_abs_grad_threshold 0.00015 --opacity_cull_threshold 0.05 --exposure_compensation --checkpoint_iterations 7_099 11_099 14_999"
